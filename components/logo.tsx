...
export const Logo: React.FC<LogoProps> = ({
  ...
  // Original aspect ratio: 20x20 (1:1)
  const width = height
  // Colors for dark mode (original)
  const darkModeColors = {
    background: "#D6FF62",
    text: "#0B151E",
  }

  // Colors for light mode (inverted)
  ...
  return (
    <svg
      ...
      className={className}
    >
      <rect width="20" height="20" rx="4.26667" fill={colors.background} />
      <mask
        id="mask0_3269_819"
        style={{
          maskType: "luminance",
...
export const Wordmark: React.FC<WordmarkProps> = ({
  ...
  // Original aspect ratio: 133x22 (6.045:1)
  const width = height * (133 / 22)
  // Colors for dark mode (original)
  const darkModeColors = {
    fill: "#D6FF62", // primary-dark equivalent
  }

  // Colors for light mode (inverted)
  const lightModeColors = {
    fill: "#0B151E", // primary-light equivalent
  }
